-- yb-Reference — Toggle reference mode (companion action)
--
...
-- that the open yb-Reference window picks up on its next frame and acts on.
--
...
-- If the yb-Reference window isn't open, pressing this does nothing: the main script
...
reaper.SetExtState("yb-Reference", "ref_toggle_request", "1", false)
